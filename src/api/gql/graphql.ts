...
export type OrganizationBillSummary = {
  ...
  total_amount: Scalars['Int']['output'];
  total_bill_count: Scalars['Int']['output'];
...
export type OrganizationCustomerStatement = {
  ...
  thirty_one_to_sixty_days_due_amount?: Maybe<Scalars['Int']['output']>;
  total_amount: Scalars['Int']['output'];
  total_invoice_count: Scalars['Int']['output'];
...
export type UserOrganizationInviteCollaboratorsQuery = { __typename?: 'Query', userOrganizationInviteCollaborators: Array<{ __typename?: 'OrganizationInvite', id: string, email: string, role: ORGANIZATION_USER_ROLE, code: string, expires_at: any, accepted_at?: any | null, canceled_at?: any | null, rejected_at?: any | null, created_at: any, updated_at: any, organization_id: string, created_by_user_id: string, created_by_user: { __typename?: 'User', email: string } }> };

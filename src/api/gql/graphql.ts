...
type OrganizationCustomerStatementLineFragment_OrganizationCustomerStatementInvoiceLine_Fragment = { __typename?: 'OrganizationCustomerStatementInvoiceLine', amount: number, code: string, created_at: any, currency_code: CURRENCY, date: any, due_date: any, id: string, organization_customer_id: string, organization_invoice_id: string, paid_amount: number, running_balance: number, invoice_status: string, type: string, updated_at: any, organization_invoice: { __typename?: 'OrganizationCustomerStatementInvoiceLineData', payment_options: Array<{ __typename?: 'OrganizationInvoicePaymentOption', method: PAYMENT_METHOD, url?: string | null, payload?: any | null }>, organization_acct_provider_conn_invoices: Array<{ __typename?: 'OrganizationAcctProviderConnInvoice', organization_acct_provider_conn: { __typename?: 'OrganizationAcctProviderConn', acct_provider: ACCT_PROVIDER, status: ORGANIZATION_ACCT_PROVIDER_CONN_STATUS } }> } };

type OrganizationCustomerStatementLineFragment_OrganizationCustomerStatementTransactionLine_Fragment = { __typename?: 'OrganizationCustomerStatementTransactionLine', amount: number, code: string, created_at: any, currency_code: CURRENCY, date: any, due_date: any, id: string, organization_customer_id: string, organization_invoice_transaction_id: string, paid_amount: number, running_balance: number, transaction_status: string, type: string, updated_at: any, organization_invoice_transaction: { __typename?: 'OrganizationCustomerStatementTransactionLineData', links: Array<{ __typename?: 'OrganizationInvoiceTransactionLink', id: string, amount: number, organization_invoice_id: string }>, organization_acct_provider_conn_invoice_transactions: Array<{ __typename?: 'OrganizationAcctProviderConnInvoiceTransaction', organization_acct_provider_conn: { __typename?: 'OrganizationAcctProviderConn', acct_provider: ACCT_PROVIDER, status: ORGANIZATION_ACCT_PROVIDER_CONN_STATUS } }> } };

export type OrganizationCustomerStatementLineFragmentFragment = OrganizationCustomerStatementLineFragment_OrganizationCustomerStatementInvoiceLine_Fragment | OrganizationCustomerStatementLineFragment_OrganizationCustomerStatementTransactionLine_Fragment;
